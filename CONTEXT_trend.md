...
| 25 | **AH: 베어마켓 시 기존 포지션 강제 청산** | SPY가 MA200 아래로 내려가면 신규 진입 차단만 하는 현재 방식에서 → 기존 보유 포지션도 전량 청산하도록 변경. 2022년 1월 손실(-19.6%)의 직접 원인 해결 시도. bear_filter='block' 조건 충족 시 sell_all 로직 추가 | 미완료 |

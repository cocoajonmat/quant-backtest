...
| **+ ADX 20+ 필터 (실험19, 현재 채택)** | **+593.7%** | **59.2%** | **-18.4%** | **1.73** |
| NDX100 동적 유니버스 (실험12) | +144.5% | 23.9% | -22.6% | 0.83 |
| NDX100 Top30 필터 강화 (실험13) | +188.1% | 28.9% | -30.7% | 0.99 |

현재 채택 파라미터: hybrid / bear=block(MA200) / pct12 / trailing_stop=original / atr_sizing=4.0% / max_positions=4 / adx_threshold=20 / 16종목
...
**다음 작업:** CONTEXT_supercycle.md 실험 목록 참고
1. ADX 15/18/20/22 세밀 스윕 — ADX 최적값 정밀 탐색
2. Strong 신호 임계값 상향 (80+) — 일반 추세추종 전략에서 실험 예정

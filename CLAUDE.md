...
| **+ MA200 block (실험10, 현재 채택)** | **+590.9%** | **59.1%** | **-21.0%** | **1.72** |
| NDX100 동적 유니버스 (실험12) | +144.5% | 23.9% | -22.6% | 0.83 |
| NDX100 Top30 필터 강화 (실험13) | +188.1% | 28.9% | -30.7% | 0.99 |

현재 채택 파라미터: hybrid / bear=block(MA200) / pct12 / trailing_stop=on / atr_sizing=4.0% / 16종목
...
- **다음 방향: 섹터 ETF 모멘텀 기반 강세 섹터 필터링**

**다음 작업:** CONTEXT.md 실험 목록 참고
1. 섹터 ETF 모멘텀 필터 추가 (강세 섹터 종목만 선별)
2. Strong 신호 임계값 상향 (80+) + NDX 유니버스
3. max_positions=5로 NDX100 재실험
